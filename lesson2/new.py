...
a = [1, 2, 3, 4]
print(a[0])
a.append(100) #додає значення в кінець списку
print(a)
a.remove(100)
print(a)
...
# той же ліст тільки не можемо його змінити (зберігає порядок)
print("===========tuple============")
b = (1, 2, 3)
print(b)
...
print("===========dict============")
d = {"name": "Petr", "age": 20}
d["ndsvs"] = "sfgdf" # додаємо нове значення
print(d)
print(d["age"])
d["age"] = 21
print(d)
